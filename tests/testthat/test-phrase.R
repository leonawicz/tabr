...
test_that("phrase returns as expected", {
  ...
  expect_equal(as.character(p("d,, e_e_ a_' b_'d", "1 2 4.. 8.")), "<d,,>1 <eses>2 <as'>4.. <bes' d>8.")
  expect_equal(as.character(p("d,, e_e_ a_' b_'d", "1 2 4.. 8.", abb = FALSE)), "<d,,>1 <eesees>2 <aes'>4.. <bes' d>8.")
  ...
  expect_equal(as.character(p("d,,e_e_3 a_4b_4d", "2 2", "321 321")), y)
  expect_equal(as.character(p("d,,e_e_3 a_4b_4d", "2*2", "321*2")), y)
  expect_equal(as.character(p("d,,e_e_3 a_4b_4d", 2, "321 3s")), y)
