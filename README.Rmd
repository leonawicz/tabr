...
More can be done with music notation syntax converters, moving to and from data frames, and between classes. New classes `noteinfo` and `music` have been added along with accompanying functions.
