...
<h4 style="padding:0px;margin:10px;">R for music data extraction and analysis</h4>

```{r md_pkg_ref2, echo = FALSE, results = "asis", eval = is_md}
cat('See the [R-Music](https://github.com/r-music) organization on GitHub for more R packages related to music data extraction and analysis. The R-Music [blog](https://r-music.rbind.io/) provides package introductions and examples.')
```

```{r html_pkg_ref2, echo = FALSE, results = "asis", eval = !is_md}
cat('See the [R-Music](https://github.com/r-music) organization on GitHub for more R packages related to music data extraction and analysis.<br/>The R-Music [blog](https://r-music.rbind.io/) provides package introductions and examples.')
```
