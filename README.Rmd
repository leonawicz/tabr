...
All things considered, the next release of `tabr` will be a big improvement. You can get many of these developments now by installing version 0.3.9.9000 from GitHub, which all the current online documentation is updated for (this README, `pkgdown` website, vignettes).
