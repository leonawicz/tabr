...
cat('<p style="text-align:center;"><img src="https://github.com/leonawicz/tabr/blob/master/data-raw/tabr_logo.png?raw=true" width="400px" align="center"></p><br/>\n\nCreate guitar tablature ("tabs") from R code with `tabr`. The `tabr` package provides programmatic music notation and a wrapper around [LilyPond](http://lilypond.org/) for creating quality guitar tablature.')
```

```{r html_doc1, echo=FALSE, results="asis", eval=!is_md}
cat('Create guitar tablature ("tabs") from R code with `tabr`. The `tabr` package provides programmatic music notation and a wrapper around [LilyPond](http://lilypond.org/) for creating quality guitar tablature.<img src="tabr_logo_small.png" style="float:right;margin-left:10px;width:400px;">')
```
...
cat('See the pdf result embedded at the [tabr website](https://leonawicz.github.io/tabr/).')
```

```{r html_doc2, echo=FALSE, results="asis", eval=!is_md}
cat('<embed src="phrase.pdf?#zoom=175" width="100%" height="300"></embed><br/>')
```
...
cat('## References and resources\n\nThere is a rich collection of vignette tutorials and examples as well as complete package documentation available at the `tabr` [website](https://leonawicz.github.io/tabr/).')
```

```{r html_pkg_ref, echo = FALSE, results = "asis", eval = !is_md}
cat('## Other resources')
```

```{r md_pkg_ref2, echo = FALSE, results = "asis", eval = is_md}
cat('<img src="https://raw.githubusercontent.com/r-music/site/master/img/logo.png" style="float:left;margin-right:20px;" width="120"><div><h3 style="margin-bottom:5px;">R-Music</h3>\n<h4 style="padding:0px;margin-top:5px;margin-bottom:5px;">R for music data extraction and analysis</h4>\n\nSee the <a href="https://github.com/r-music">R-Music</a> organization on GitHub for more R packages related to music data extraction and analysis. The R-Music <a href="https://r-music.rbind.io/">blog</a> provides package introductions and examples.</div>')
```

```{r html_pkg_ref2, echo = FALSE, results = "asis", eval = !is_md}
cat('<img src="https://raw.githubusercontent.com/r-music/site/master/img/logo.png" style="float:left;margin-right:20px;" width="120"><div><h3 style="padding-top:50px;">R-Music</h3>\n<h4 style="padding:0px;margin-top:5px;margin-bottom:5px;">R for music data extraction and analysis</h4>\nSee the [R-Music](https://github.com/r-music) organization on GitHub for more R packages related to music data extraction and analysis.<br/>The R-Music [blog](https://r-music.rbind.io/) provides package introductions and examples.</div>')
```
