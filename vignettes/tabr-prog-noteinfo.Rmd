...
`info_duration` is a handy function that strips away all information but note durations. The other functions return logical vectors indicating timesteps where certain types of information are present.
