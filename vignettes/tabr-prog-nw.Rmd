...
When coercing a noteworthy character string to one that has the `noteworthy` class, it is possible to override some format attributes that are derived from the input string:
