...
p4a <- glue(sfp("5s*12", "75000*12", i1), sfp("5s*13", "55000*13", i2), sfp("5s*13", "35450*13", i2))
p4b <- sfp("5s*6 64321*6", "02200*6 30005*3 20233*3", i4)
p4c <- sfp("6s*6 64321*6", "022000*6 30005*3 20233*3", i4)
p4 <- glue(p4a, p4b, p4a, p4c)
...
```{r g2_3}
track2 <- track(glue(p1a, p1a2, p0, p2, p3, p4, p1a, p1a2, p5, p6, p7, p8, p9, p10a, p2, p2, p10b, p11))
```
