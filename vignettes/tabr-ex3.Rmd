...
```{r g2_2}
p1a <- sfp(s1, "75000*3 75080*3 7005*3 75007*3", i1)
p1a2 <- sfp(s1, "75000*3 75080*3 7005*3 75080*3", i1)
p0 <- volta(sfp(s1, "75000*3 75007*3 7005*3 75007*3", i1), 3, silent = TRUE)

p1b <- sfp(s2, "55000*3 55003*3 55005*4 55003*3", i2)
p1c <- sfp(s3, "35450*3 35453*3 35455*5 7 007*2", i3)
p1d <- sfp(s4, "022000*3 022003*3 30005*3 20233*3", i4)
p1d2 <- sfp(s4, "022000*3 022002*3 20233*3 30005*3", i1)

p2 <- glue(p1a, p1b, p1c, p1d)
p3 <- volta(glue(p1a, p1b, p1c), 1, list(p1d, p1d2), TRUE)

p4 <- glue(sfp("5s*12", "75000*12", i1), sfp(s2, "55000*13", i2), sfp(s2, "35450*13", i2), sfp(s4, "022000*6 30005*3 20233*3", i4))

p5 <- sfp("6s~ 6s 5s*14", "022000~ 022000 75000*3 75080*3 75007 75000 75008 75000 75080 75000 75007 75000", "1 1 4 8 8 4 8*10")
