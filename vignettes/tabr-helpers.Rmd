...
```{r tp1}
notes1 <- "r a2 c3 f3 d3 a3 f3 b3~ b3~ b3"
notes2 <- "r a3 c4 d4 a3 f4 d4 g4~ g4~ g4"
...
```{r tuplet2}
p1 <- glue(triplet("c4 d4 e4", 8, "4 3 3"), 
           tuplet("f4 g4 a4 b4 c5 b4", 8, "3 2 2 1 1 1", 6, 4), 
           tuplet("a4 g4 f4 g4 f4 e4 f4 e4 d4 e4 d4 c4", 16, "2 2 3 2 3*7 4"),
