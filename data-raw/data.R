.predefined_tunings <- c(
  standard = "e,a,dgbe'", seven = "b,,e,a,dgbe'",
  dropD = "d,a,dgbe'", dropC = "c,g,cfad'",
  openG = "d,g,dgbd'", openD = "d,a,df#ad'",
  DADGAD = "d,a,dgad'", lute = "e,a,df#be'",
  asus4 = "e,a,deae'",
  bass = "e,,a,,d,g,", bassdropD = "d,,a,,d,g,",
  bass5 = "b,,,e,,a,,d,g,", bass6 = "b,,,e,,a,,d,g,c",
  mandolin = "gd'a'e''",
  banOG = "g'dgbd'", banC = "g'cgbd'",
  banModal = "g'dgc'd'", banOD = "a'df#ad'",
  banODm = "a'df#ad'",
  ban4OG = "g'dgbd'", ban4C = "g'cgbd'",
  ban4Modal = "g'dgc'd'", ban4OD = "a'df#ad'",
  ban4ODm = "a'df#ad'",
  uke = "g'c'e'a'", ukeD = "a'd'f#'b'",
  ukeTenor = "gc'e'a'", ukeBaritone = "dgbe'",
  violin = "gd'a'e''", viola = "cgd'a'",
  cello = "c,g,da", doublebass = "e,,a,,d,g,"
)
